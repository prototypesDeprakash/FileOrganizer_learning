...
# this is a more hardcoded version of the file manager that im trying to build 
#the architecture is shit and hard to navigate since everything is inside a single main class
#the file extentions are hardcoded which is shit and bad
#planning to implemnt a conformation option after showing the summary
#planning to implemnt a final reslt summary and a undo option
#planning to implement a GUI that allows easy access of this tool and publish it
